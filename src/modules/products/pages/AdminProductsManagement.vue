...
import ProductsList from '@/modules/products/components/Admin/ProductsList.vue'
import { VPagination } from '@/components/UI'
import ProductsForm from '@/modules/products/components/Admin/ProductsForm.vue'
...
import type { SpecificationCreateForm } from '../model/products.types'
