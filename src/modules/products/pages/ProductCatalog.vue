...
import { useFilterStore } from '@/modules/products/stores/filterStore'
import { useCustomRouter, useCustomRoute } from '@/shared/composables/customRouter'
import { VPagination, VButton } from '@/components/UI'
import ProductBlock from '@/modules/products/components/ProductCatalog/ProductBlock.vue'
import Search from '@/modules/products/components/ProductCatalog/Search.vue'
import Sort from '@/modules/products/components/ProductCatalog/Sort.vue'
import Filters from '@/modules/products/components/ProductCatalog/Filters.vue'
import ProductBlockSkeleton from '@/modules/products/components/ProductCatalog/ProductBlockSkeleton.vue'
import FiltersMobile from '@/modules/products/components/ProductCatalog/Filters.mobile.vue'
import { getValuesFromQuery } from '@/modules/products/components/ProductCatalog/useFeatureStaticFilter'
