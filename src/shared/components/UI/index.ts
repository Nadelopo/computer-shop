...
export { default as VButtons } from './VButtons.vue'
...
export { default as VCarouselSlide } from './VCarousel/VCarouselSlide.vue'
export { default as VInputFile } from './VInputFile/VInputFile.vue'
export { default as VTable } from './VTable.vue'
export { default as VTags } from './VTags.vue'
export { default as VRatingStars } from './VRatingStars.vue'
export { default as VActionIcon } from './VActionIcon.vue'
